...
from hjson.compat import BytesIO, b, text_type, u, unichr
...
class TestUnicode(TestCase):
    ...
    def test_big_unicode_encode(self):
        ...
        self.assertEqual(json.dumpsJSON(u, ensure_ascii=False), '"\U0001d120"')
    ...
    def test_default_encoding(self):
        self.assertEqual(json.loads('{"a": "\xe9"}'.encode("utf-8")), {"a": "\xe9"})
    ...
    def test_ensure_ascii_still_works(self):
        ...
        for c in map(unichr, range(0, 127)):
            self.assertEqual(json.dumpsJSON(c, ensure_ascii=False), json.dumpsJSON(c))
        snowman = "\N{SNOWMAN}"
